...
# Implementation 
I used Docker to run the API files in a local container and service requests from the website. The API carries information on an artist(s) and their essential albums. A user can request to view, create, edit, or delete information collectively or by a selected album or artist(s).  
